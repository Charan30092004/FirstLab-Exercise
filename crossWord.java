// 15. Given a 2D board and a word, find if the word exists in the grid. The word
...
public class crossWord
{
    ...
    public static void main(String ar[])
    {
        ...
        try(Scanner sc=new Scanner(System.in))
        {
            ...
            n1=sc.nextInt();
            System.out.print("Enter the Number of Column in a Row : ");
            n2=sc.nextInt();
            a=new char[n1][n2];
            for(i=0;i<n1;i++)
            {
                for(j=0;j<n2;j++)
                {
                    System.out.print("Enter the "+ (j+1)+" letter of "+(i+1)+" Word : ");
